...
class Configuration:   
    ...
    def get_data_ingestion_config(self) ->DataIgestionConfig :
        try:
            ...
            data_ingestion_info = self.config_info[DATA_INGESTION_CONFIG_KEY]   #this will give imformation  
    ...
    def get_data_evalution_config(self) -> ModelEvaluationConfig:
        pass
    ...
    def get_training_pipeline_config(self) -> TainingPipelineConfig:
        try:
            ...
            training_pipeline_config = TainingPipelineConfig(artifact_dir=artifact_dir)
